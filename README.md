...
[![Latest release](https://img.shields.io/github/v/release/bwt/libbwt?color=orange)](https://github.com/bwt-dev/libbwt/releases/tag/v0.2.0)
...
$ wget https://github.com/bwt-dev/libbwt/releases/download/v0.2.0/libbwt-0.2.0-x86_64-linux.tar.gz
...
The signature verification should show `Good signature from "Nadav Ivgi <nadav@shesek.info>" ... Primary key fingerprint: FCF1 9B67 ...` and `libbwt-0.2.0-x86_64-linux.tar.gz: OK`.
